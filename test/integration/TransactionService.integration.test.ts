...
import { TransactionType } from '../../src/types/enums/transaction.enum'
...
describe('TransactionService Integration Tests', () => {
    ...
    describe('getUserTransactions', () => {
        it('should fetch all user transactions', async () => {
            ...
            transactions.forEach((tx, index) => {
                ...
                // === LOG SUCCESS ===
                //console.log('User Transaction:', {id: tx.id,amount: tx.amount,type: tx.type,ref: tx.reference,status: tx.status});
            });
    ...
    describe('getUserDeposits', () => {
        it('should fetch all user transactions', async () => {
            ...
            const result = await transactionService.getDeposits()
    ...
    describe('getTransactionById', () => {
        it('should fetch a transaction by ID', async () => {
            ...
            const fetched: TransactionDto =
                await transactionService.getDeposit({ id });
            ...
            console.log('Fetched Transaction by ID:', fetched);
